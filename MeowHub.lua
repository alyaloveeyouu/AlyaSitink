...
local function NotificacaoNightMystic(titulo, mensagem)
    local success = pcall(function()
        ...
        local LogoID = "rbxassetid://129912951742770"
    ...
    if not success then
        warn("[Meow] Erro ao exibir notificação")
    end
end

NotificacaoNightMystic("Meow Hub", "Script carregado com sucesso!")

-- ========================================
-- SAVE SYSTEM (Optimized)
-- ========================================
local HttpService = Services.HttpService
local FolderName = "Meow Hub"
...
-- ===============================  
local speed = dist <= 15 and (getgenv().TweenSpeedNear or 600) or (getgenv().TweenSpeedFar or 350)
...
imageButton.Image = "rbxassetid://129912951742770"
    ...
    Callback = function(v)
        ...
        task.spawn(function()
            while _G.BlackLeg do
                if World3 then
                    _tp(CFrame.new(-5045,372,-3182))
                elseif World2 then
                    _tp(CFrame.new(-4753,37,-4845))
                elseif World1 then
                    _tp(CFrame.new(-981,16,3993))
                end
...
Shop:AddToggle({
    ...
    Callback = function(v)
        ...
        task.spawn(function()
            while _G.Fishman do
                if World3 then
                    _tp(CFrame.new(-5026,375,-3196))
                elseif World2 then
                    _tp(CFrame.new(-4960,39,-4663))
                elseif World1 then
                    _tp(CFrame.new(61590,23,988))
                end
...
Shop:AddToggle({
    ...
    Callback = function(v)
        ...
        task.spawn(function()
            while _G.Electro do
                if World3 then
                    _tp(CFrame.new(-5000,375,-3196))
                elseif World2 then
                    _tp(CFrame.new(-4871,37,-4769))
                elseif World1 then
                    _tp(CFrame.new(-5383,16,-2153))
                end
    ...
    Callback = function(v)
        ...
        task.spawn(function()
            while _G.DragonBreath do
                if World3 then
                    _tp(CFrame.new(-4985,374,-3207))
                elseif World2 then
                    _tp(CFrame.new(701,189,651))
                end
    ...
    Callback = function(v)
        ...
        task.spawn(function()
            while _G.SuperHuman do
                if World3 then
                    _tp(CFrame.new(-5002,374,-3202))
                elseif World2 then
                    _tp(CFrame.new(1373,250,-5191))
                end
    ...
    Callback = function(v)
        ...
        task.spawn(function()
            while _G.DeathStep do
                if World3 then
                    _tp(CFrame.new(-5000,318,-3218))
                elseif World2 then
                    _tp(CFrame.new(6354,330,-6766))
                end
    ...
    Callback = function(v)
        ...
        task.spawn(function()
            while _G.Sharkman do
                if World3 then
                    _tp(CFrame.new(-5002,374,-3201))
                elseif World2 then
                    _tp(CFrame.new(-2603,242,-10313))
                end
    ...
    Callback = function(v)
        ...
        task.spawn(function()
            while _G.ElectricClaw do
                if World3 then
                    _tp(CFrame.new(-10368,334,-10134))
                end
...
NotificacaoNightMystic("Meow Hub", "✅ Todos os sistemas carregados!")
